...
# undef any
# pragma clang attribute push(__attribute__((external_source_symbol(language="Swift", defined_in="daily_commit_checker",generated_declaration))), apply_to=any(function,enum,objc_interface,objc_category,objc_protocol))
# pragma pop_macro("any")
#endif

@class NSMenu;

SWIFT_CLASS("_TtC20daily_commit_checker11AppDelegate")
@interface AppDelegate : NSObject <NSApplicationDelegate>
@property (nonatomic, strong) IBOutlet NSMenu * _Null_unspecified mainMenu;
- (void)applicationDidFinishLaunching:(NSNotification * _Nonnull)aNotification;
- (void)getNumberToShow;
...
SWIFT_CLASS("_TtC20daily_commit_checker14ViewController")
